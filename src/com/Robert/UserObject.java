...
public class UserObject extends JFrame {
    ...
    public UserObject() {
        ...
        Element relation = doc.createElement("Relates");
        relation.setAttribute("extends", "Point");
            ...
            public String convertValueToString(Object cell)
            {
                if (cell instanceof mxCell)
                {
                    ...
                    if (value instanceof Element)
                    {
                        ...
                        else if (elt.getTagName().equalsIgnoreCase("relates"))
                        {
                            return elt.getTagName() + " (Extends "
                                    + elt.getAttribute("extends") + ")";
                        }
